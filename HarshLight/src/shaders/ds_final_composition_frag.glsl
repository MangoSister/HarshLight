...
uniform sampler2D BufIndirectDiffuse;
...
void main()
{
	...
	albedo *= albedo; // approximate gamma correction (2 instead of 2.2)
	...
	//indirect diffuse
	fragColor.xyz += texture(BufIndirectDiffuse, vs_Texcoord).xyz;
