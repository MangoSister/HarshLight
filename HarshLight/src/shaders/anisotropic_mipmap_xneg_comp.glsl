...
void main()
{
	...
	val_parent += val_child[4] + (1.0 - val_child[4].w) * val_child[0];
	val_parent += val_child[5] + (1.0 - val_child[5].w) * val_child[1];
	val_parent += val_child[6] + (1.0 - val_child[6].w) * val_child[2];
	val_parent += val_child[7] + (1.0 - val_child[7].w) * val_child[3];
	val_parent *= 0.25;
