...
void main()
{
	...
	val_parent += val_child[0] + (1.0 - val_child[0].w) * val_child[4];
	val_parent += val_child[1] + (1.0 - val_child[1].w) * val_child[5];
	val_parent += val_child[2] + (1.0 - val_child[2].w) * val_child[6];
	val_parent += val_child[3] + (1.0 - val_child[3].w) * val_child[7];
	val_parent *= 0.25;
